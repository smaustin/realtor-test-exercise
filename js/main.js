 ...
 */
let fillHousesHTML = (houses = self.houses) => {
 ...
 */
let fetchFilterOptions = (filters) => {
    // check for houses
 ...
 * Set fitler selects.
 */
let fillFilterOption = (filter, uniqueItems) => {
